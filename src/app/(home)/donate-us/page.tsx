            ...
            <div className="max-w-3xl 2xl:max-w-4xl mx-auto">
                ...
                <div className="donate-p">
                    <p className="text-[16px] font-medium">
                        ...
                        empowering you to explore the Scriptures and deepen your
                        understanding through advanced AI technology.
                    </p>
                    <p className="pt-4 text-[16px] font-medium">
                        This platform thrives solely through the generosity of individuals
                        who share our vision. Your support is essential for maintaining
                        the website and ensuring it remains available to those seeking to
                    ...
                    <p className="pt-4 text-[16px] font-medium">
                        ...
                        globally, we invite you to consider making a donation. Every contribution,
                        no matter the size, is crucial in keeping this platform operational and
                        expanding its features for all who seek to learn.
                    </p>
                    <p className="pt-4 text-[16px] font-medium">
                        We trust in God’s provision and are genuinely grateful for
                        your willingness to support this mission. Thank you for being
                        part of our community as we strive to make the Word accessible
                ...
                <div className="pt-6 text-center">
                    ...
                    <p className="pt-2 text-[16px] font-medium">
                        ...
                        Your support enables us to continue this important work!
                    </p>
